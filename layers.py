...
import numpy as np
import copy
from activation_functions import Sigmoid, ReLU, SoftPlus, LeakyReLU, TanH, ELU, SELU, Softmax
...
class Activation(Layer):
    ...
    def derivatives(self, X):
        return self.activation.derivatives(X)
    ...
    def backward_pass(self, acc_grad):
        return acc_grad * self.activation.derivatives(self.layer_input)
